  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='xuesheng'"  label="学院班级" prop="xueyuanbanji">
          <el-input v-model="ruleForm.xueyuanbanji"               placeholder="学院班级" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="所在学院" prop="suozaixueyuan">
          <el-input v-model="ruleForm.suozaixueyuan"               placeholder="所在学院" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item  v-if="flag=='jiaoshi'" label="入职时间" prop="ruzhishijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
