<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学年学期" prop="xuenianxueqi">
          <el-input v-model="ruleForm.xuenianxueqi" 
              placeholder="学年学期" clearable  :readonly="ro.xuenianxueqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学年学期" prop="xuenianxueqi">
              <el-input v-model="ruleForm.xuenianxueqi" 
                placeholder="学年学期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="课程性质" prop="kechengxingzhi">
          <el-select v-model="ruleForm.kechengxingzhi" placeholder="请选择课程性质">
            <el-option
                v-for="(item,index) in kechengxingzhiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="课程性质" prop="kechengxingzhi">
	      <el-input v-model="ruleForm.kechengxingzhi"
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="成绩备注" prop="chengjibeizhu">
          <el-input v-model="ruleForm.chengjibeizhu" 
              placeholder="成绩备注" clearable  :readonly="ro.chengjibeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="成绩备注" prop="chengjibeizhu">
              <el-input v-model="ruleForm.chengjibeizhu" 
                placeholder="成绩备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所得绩点" prop="suodejidian">
          <el-input v-model="ruleForm.suodejidian" 
              placeholder="所得绩点" clearable  :readonly="ro.suodejidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所得绩点" prop="suodejidian">
              <el-input v-model="ruleForm.suodejidian" 
                placeholder="所得绩点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学院班级" prop="xueyuanbanji">
          <el-input v-model="ruleForm.xueyuanbanji" 
              placeholder="学院班级" clearable  :readonly="ro.xueyuanbanji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学院班级" prop="xueyuanbanji">
              <el-input v-model="ruleForm.xueyuanbanji" 
                placeholder="学院班级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kechengmingcheng = true;
          ...
          if(o=='kechengxingzhi'){
            this.ruleForm.kechengxingzhi = obj[o];
	    this.ro.kechengxingzhi = true;
            continue;
          }
          if(o=='xuefen'){
	    ...
	    this.ro.chengji = true;
          ...
          if(o=='chengjibeizhu'){
            this.ruleForm.chengjibeizhu = obj[o];
	    this.ro.chengjibeizhu = true;
            continue;
          }
          if(o=='suodejidian'){
            this.ruleForm.suodejidian = obj[o];
	    this.ro.suodejidian = true;
            continue;
          }
          if(o=='xuehao'){
	    ...
	    this.ro.xueshengxingming = true;
          ...
          if(o=='xueyuanbanji'){
            this.ruleForm.xueyuanbanji = obj[o];
	    this.ro.xueyuanbanji = true;
            continue;
          }
      ...
      this.$http({
		...
		if(json.suozaixueyuan!=''&&json.suozaixueyuan){
              		this.ruleForm.suozaixueyuan = json.suozaixueyuan
		}
        } else {
    ...
    xuehaoChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
              ...
              if(data.data.xueyuanbanji){
                this.ruleForm.xueyuanbanji = data.data.xueyuanbanji
              }
        } else {
          this.$message.error(data.msg);
        }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `chengjishuju/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chengjishujuCrossAddOrUpdateFlag = false;
                  this.parent.search();
