    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="备注消息" prop="beizhuxiaoxi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="备注消息"
                  v-model="ruleForm.beizhuxiaoxi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.beizhuxiaoxi" label="备注消息" prop="beizhuxiaoxi">
                    <span>{{ruleForm.beizhuxiaoxi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.suozaixueyuan = true;
          ...
          if(o=='beizhuxiaoxi'){
            this.ruleForm.beizhuxiaoxi = obj[o];
	    this.ro.beizhuxiaoxi = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yujingxiaoxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yujingxiaoxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
