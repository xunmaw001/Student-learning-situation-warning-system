  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:20px">
        <h1 class="h1" style="color:#000;fontSize:26px;">学生学情预警系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   <div class="label">学院班级</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xueyuanbanji" class="input" type="text" placeholder="学院班级">
			   </div>
			 </div> -->
			<el-form-item label="学院班级" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.xueyuanbanji" autocomplete="off" placeholder="学院班级"  />
			</el-form-item>
			...
			<el-form-item label="所在学院" class="input" v-if="tableName=='jiaoshi'">
